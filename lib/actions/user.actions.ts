...
export const exchangePublicToken = async ({
  ...
  try {
    ...
    console.log("Creating funding source for customer:", user.dwollaCustomerId);
    ...
    if (!fundingSourceUrl) {
      console.error("Failed to create funding source URL — dwollaCustomerId:", user.dwollaCustomerId);
    ...
    console.log("Bank account saved to Appwrite successfully!");
